...
# Create buttons
forward_button = tk.Button(root, text="^\nForward", width=15, command=move_forward)
backward_button = tk.Button(root, text="Backward\nv", width=15, command=move_backward)
left_button = tk.Button(root, text="< Left", width=15, command=move_left)
right_button = tk.Button(root, text="Right >", width=15, command=move_right)
